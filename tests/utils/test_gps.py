...
def test_local_coordinates_from_lat_lon():
    ...
    assert gps.local_coordinates_from_lat_lon(lat1, lon1, lat2, lon2) == (41.09733383696133, 42.43931498114769, 51.08926705078824, 41.839736236557286, 67.65938702776376, 104.61172932214025)
